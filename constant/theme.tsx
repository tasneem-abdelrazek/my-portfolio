...
export const colors = {
  primary: {
    pink: '#FFBBE1',
    purple: '#DD7BDF',
    gradient: 'from-[#FFBBE1] via-[#DD7BDF] to-[#FFBBE1]',
    gradientReverse: 'from-[#DD7BDF] via-[#FFBBE1] to-[#DD7BDF]',
  },
  background: {
    main: '#e964c1ff',
    dark: 'from-gray-900 via-purple-950 to-black',
    darkAlt: 'from-gray-900 via-purple-950 to-gray-900',
  },
  text: {
    white: 'text-white',
    gray: 'text-gray-400',
