...
//         } duration-700 h-[13vh] z-[1000] fixed w-full`}
//       >
//         {/* Top Gradient Line */}
...
//                 key={link.name}
//                 href={link.path}
//                 className="relative px-6 py-3 text-base xl:text-lg font-bold text-white/80 hover:text-white transition-all duration-300 group"
...
//                 <span className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-pink-400 via-purple-400 to-fuchsia-400 group-hover:w-3/4 transition-all duration-300 rounded-full shadow-lg shadow-purple-500/50"></span>
                
//                 {/* Top Dot Indicator */}
//                 <span className="absolute top-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-gradient-to-r from-pink-400 to-fuchsia-400 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg shadow-pink-500/50"></span>
//               </Link>
//             ))}
//           </div>
          ...
          <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
            {NavLinks.map((link, index) => (
              ...
              >
                ...
                {/* Bottom Line Indicator */}
                <span className={`absolute bottom-1 left-1/2 -translate-x-1/2 h-1 bg-gradient-to-r from-pink-400 via-purple-400 to-fuchsia-400 rounded-full shadow-lg shadow-purple-500/50 transition-all duration-300 ${
                  activeSection === link.path.replace('#', '')
                    ? 'w-3/4'
                ...
                {/* Top Dot Indicator */}
                <span className={`absolute top-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-gradient-to-r from-pink-400 to-fuchsia-400 rounded-full shadow-lg shadow-pink-500/50 transition-all duration-300 ${
                  activeSection === link.path.replace('#', '')
                    ? 'opacity-100'
